...
@section('content')
    ...
    <div class="card card-primary fox-glass2-light">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form method="post" class="create-form" enctype="multipart/form-data" action="{{route('d.store.section')}}">
            @csrf
            <div class="card-body">
                <div class="form-group">
                    <label for="exampleInputEmail1">{{__('dashboard.section.name.en')}}</label>
                    <input type="text" name="section_name_en" class="form-control" id="exampleInputEmail1" placeholder="{{__('dashboard.section.name.en')}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="section_name_ar" class="form-control" id="exampleInputEmail1" placeholder="{{__('dashboard.section.name.ar')}}">
