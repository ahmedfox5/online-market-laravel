...
@section('content')
    ...
    <div class="card card-primary fox-glass2-light">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form method="post" class="create-form" enctype="multipart/form-data" action="{{route('d.product.store')}}">
            @csrf
            <div class="card-body">
                <div class="form-group">
                    <label for="exampleInputEmail1">{{__('dashboard.product.name.en')}}</label>
                    <input type="text" name="product_name_en" class="form-control" id="exampleInputEmail1" placeholder="{{__('dashboard.product.name.en')}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="product_name_ar" class="form-control" id="exampleInputEmail1" placeholder="{{__('dashboard.product.name.ar')}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="price" class="form-control" id="exampleInputEmail1" placeholder="{{__('dashboard.product.price')}}">
                    @error('price')
                        <p style="color: #ff1111;" role="alert" >{{$message}}</p>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea rows="4" name="product_desc_en" class="form-control" id="exampleInputPassword1" placeholder="{{__('dashboard.product.desc.en')}}"></textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea rows="4" name="product_desc_ar" class="form-control" id="exampleInputPassword1" placeholder="{{__('dashboard.product.desc.ar')}}"></textarea>
...
{{--                    <img src="{{asset('img/header.jpg')}}" class="img-thumbnail img-lg" alt="">--}}
{{--                </div>--}}
