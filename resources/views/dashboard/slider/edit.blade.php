...
@section('content')
    ...
    <div class="card card-primary fox-glass2-light">
        <div class="card-header fox-glass3-light">
            <h3 class="card-title">{{__('dashboard.slider.edit')}}</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form method="post" class="create-form" enctype="multipart/form-data" action="{{route('slider.update' ,request()->route()->parameters)}}">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <div class="w-100 align-items-center file_input_cont m-1 p-1 border row">
                            ...
                            <div class="col-3 row align-items-center justify-content-center">
                                <img src="{{asset('img/slides/' . $slide->image_name)}}" class="img-thumbnail img-lg " id="img_view" alt="">
                            </div>
                        </div>
                        @error('image')
                    ...
                    <div class="input-group">
                        ...
                        <div class="w-100 align-items-center file_input_cont m-1 p-1 border row">
                            ...
                            <div class="col-3 row align-items-center justify-content-center">
                                <img src="{{asset('img/slides/mobile/' . $slide->image_name)}}" class="img-thumbnail img-lg " id="img_view2" alt="">
                            </div>
                        </div>
                        @error('image2')
                        <li style="list-style: none"><p style="color: #ff1111;" role="alert" >{{$message}}</p></li>
